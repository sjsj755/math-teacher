...
def build():
    ...
    add_para(
        doc,
        "修订记录：V1.7（2026-08-08）标记阶段 4 已完成，记录练习与错题闭环（推荐/重做/周清、状态机）；"
    ...
    add_callout(
        doc,
        "当前进度",
        "阶段 0–4 ✅ 已完成；视觉改版（v0.3.0 清新学习风·克制可爱版）✅ 已完成；阶段 5–6 待开发。下一阶段：阶段 5 通知服务。",
    )
    add_bullets(
        doc,
        [
            ...
            "○ 待办：内网穿透注册（cpolar/花生壳）；阶段 5 通知服务 → 阶段 6 联调部署。",
        ],
    )
