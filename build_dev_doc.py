...
def build():
    ...
    add_para(
        doc,
        "修订记录：V1.6（2026-08-08）标记阶段 3 已完成，记录诊断与报告实现（含填空/限时题、评分引擎、雷达图）；"
    ...
    add_callout(
        doc,
        "当前进度",
        "阶段 0–3 ✅ 已完成；视觉改版（v0.3.0 清新学习风·克制可爱版）✅ 已完成；阶段 4–6 待开发。下一阶段：阶段 4 练习错题。",
    )
    add_bullets(
        doc,
        [
            ...
            "○ 待办：内网穿透注册（cpolar/花生壳）；阶段 4 练习错题 → 阶段 5 通知服务 → 阶段 6 联调部署。",
        ],
    )
